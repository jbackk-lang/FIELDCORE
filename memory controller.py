# Naprawa błędu escape'owania unicode w Pythonie dla znaków \u
...
impl KnotWord {
    /// Mask for extracting CORD_SCALE (Lambda) - Bits [63:56]
    pub const SCALE_MASK: u64 = 0xFF00_0000_0000_0000;
    
    /// Mask for extracting RELAX_DELTA (Tau) - Bits [55:44]
    ...
    /// Mask for extracting SPLIT_COUNT (Rho) - Bits [39:32]
    ...
    /// Getter for Field Density (Rho)
    #[inline(always)]
    pub fn density(&self) -> u8 {
        ((self.0 & Self::DENSITY_MASK) >> 32) as u8
    }

    /// Getter for Scale (Lambda)
    #[inline(always)]
...
print("Rust source file generated successfully.")
